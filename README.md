...
Course Todo - это современный бэкенд для управления проектами, задачами и заметками, разработанный на Go. Приложение предоставляет мощный REST API для организации личной и командной продуктивности с системой совместной работы над проектами.

### ✨ Основные возможности
- 🏗️ **Управление проектами** - совместная работа с системой ролей и приглашений
